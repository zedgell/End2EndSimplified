...
/*package*/ class Wait_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public Wait_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createConstant_0() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "wait");
  ...
  private EditorCell createProperty_0() {
    ...
    try {
      final SProperty property = PROPS.Time$MVqX;
