...
/*package*/ class findByRefernce_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public findByRefernce_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_9a7a3q_a");
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.target$oH2X;
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.target$oH2X);
    }
